    ...
    <div className="relative isolate bg-white dark:bg-primary/0 pt-24 pb-32 sm:pt-32">
      ...
      >
        <div
          ...
          className="ml-[-22rem] aspect-1313/771 w-[82.0625rem] flex-none origin-top-right rotate-[30deg] bg-linear-to-tr from-[#ccfbf1] to-[#134e4a] xl:mr-[calc(50%-12rem)] xl:ml-0"
        />
      </div>
      <div className="mx-auto max-w-5xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-semibold text-teal-700">Testimonials</h2>
