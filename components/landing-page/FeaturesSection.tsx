      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tighter text-accent/95 dark:text-teal-50">
              Powerful Features
            </h2>
            <p className="max-w-[700px] text-gray-500 md:text-xl dark:text-accent-foreground">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            ...
            <div className="flex flex-col items-center space-y-2 border border-gray-200 rounded-lg p-6 dark:border-gray-800">
              <div className="p-3 rounded-full bg-accent/10 dark:bg-teal-900">
